...
//               रु{Number(specialPrice || price).toLocaleString()}
//             </span>
//             {specialPrice && (
//               <span className="text-xs text-gray-400 line-through font-medium">
//                 रु{Number(price).toLocaleString()}
//               </span>
//             )}
//             {discount > 0 && (
  ...
  return (
    <div className="group flex flex-col bg-stone-50 dark:bg-gray-800 rounded-2xl overflow-hidden hover:shadow-xl transition-all duration-500 border border-transparent dark:border-gray-700 hover:border-stone-200 dark:hover:border-gray-600">
      ...
      >
        ...
        {/* Tag / Badge */}
        {tag && (
          <div className="absolute top-4 left-4 bg-blue-50/80 dark:bg-blue-900/80 backdrop-blur-sm text-blue-600 dark:text-blue-300 px-3 py-1 rounded-md text-[10px] uppercase font-bold tracking-wider z-10">
            {tag}
          </div>
        )}
      </div>
      ...
      {/* Content */}
      <div className="p-6 flex flex-col flex-1 bg-white dark:bg-gray-800 rounded-t-[32px] -mt-8 relative z-10 shadow-[0_-8px_30px_rgba(0,0,0,0.04)] dark:shadow-[0_-8px_30px_rgba(0,0,0,0.2)]">
        {/* Rating */}
        <div className="flex items-center gap-1 mb-3">
        ...
        <h3
          ...
          className="text-base font-bold text-gray-900 dark:text-white mb-1 cursor-pointer hover:text-blue-600 dark:hover:text-blue-400 transition-colors line-clamp-1"
        >
          {productName}
        </h3>

        <p className="text-xs text-gray-500 dark:text-gray-400 mb-4 line-clamp-1 font-medium italic">
          {description?.slice(0, 30)}...
        </p>
        ...
        <div className="mt-auto flex items-center justify-between">
          ...
          <button
            ...
            disabled={!isAvailable}
            className={`flex items-center gap-2 border border-gray-200 dark:border-gray-600 rounded-full px-5 py-2.5 text-sm font-bold transition-all duration-300 hover:bg-black dark:hover:bg-white hover:text-white dark:hover:text-black hover:border-black dark:hover:border-white disabled:opacity-50 disabled:cursor-not-allowed`}
          >
            <FiShoppingCart className="scale-110" />
            <span className="hidden sm:inline">Add to Cart</span>
          </button>
